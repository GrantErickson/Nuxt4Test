    ...
    <v-main>
      <v-container>
        <v-tabs v-model="tab" bg-color="primary" class="mb-4">
          ...
          <v-tab value="crossword" to="/crossword">📝 Crossword</v-tab>
          ...
          <v-tab value="voidcatcher2d" to="/voidcatcher2d">🌀 Void 2D</v-tab>
          <v-tab value="voidcatcher3d" to="/voidcatcher3d">🌌 Void 3D</v-tab>
        </v-tabs>
        <NuxtPage />
      </v-container>
    </v-main>
